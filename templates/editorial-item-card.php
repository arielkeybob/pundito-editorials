...
?>
<div class="editorial-item <?php echo esc_attr($post_data['class']); ?>" style="background-image: url('<?php echo esc_url($thumbnail_url); ?>');" <?php if (!$post_data['view_children']) : ?>onclick="window.location='<?php echo esc_url(get_edit_post_link($post_data['id'])); ?>';"<?php endif; ?>>
